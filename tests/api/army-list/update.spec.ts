...
describe("armies-lists/update", () => {
    ...
    it("units: valid properties - then should return 200 (OK)", async() => {
    ...
    it("units::magicItems: valid properties - then should return 200 (OK)", async() => {
        const list: List = new List("name", ARMY1.armyId, 500, [{
            unitId: 1,
            quantity: 1,
            formation: "1x1",
    ...
    it("units::magicItems: null unitOptionId & equipmentId - then should return 200 (OK)", async() => {
        const list: List = new List("name", ARMY1.armyId, 500, [{
            unitId: 396,
            quantity: 1,
            formation: "1x1",
    ...
    it("units::magicItems: undefined unitOptionId & equipmentId - then should return 200 (OK)", async() => {
        const list: List = new List("name", ARMY1.armyId, 500, [{
            unitId: 396,
            quantity: 1,
            formation: "1x1",
     ...
     */
    it("units::magicStandards: valid properties - then should return 200 (OK)", async() => {
        const list: List = new List("name", ARMY1.armyId, 500, [{
            unitId: 396,
            quantity: 5,
            formation: "3x2",
    ...
    it("units::magicStandards: null unitOptionId - then should return 200 (OK)", async() => {
        const list: List = new List("name", ARMY1.armyId, 500, [{
            unitId: 396,
            quantity: 5,
            formation: "3x2",
    ...
    it("units::magicStandards: undefined unitOptionId - then should return 200 (OK)", async() => {
        const list: List = new List("name", ARMY1.armyId, 500, [{
            unitId: 396,
            quantity: 5,
            formation: "3x2",
     ...
     * UNIT::OPTIONS
     */
    it("units::options: valid properties - then should return 200 (OK)", async() => {
        const list: List = new List("name", ARMY1.armyId, 500, [{
            unitId: 396,
            quantity: 5,
            formation: "3x2",
    ...
    it("units::specialRule: valid properties - then should return 200 (OK)", async() => {
        const list: List = new List("name", ARMY1.armyId, 500, [{
            unitId: 396,
            quantity: 5,
            formation: "3x2",
     ...
     */
    it("units::equipmentTroops: valid properties - then should return 200 (OK)", async() => {
        const list: List = new List("name", ARMY1.armyId, 500, [{
            unitId: 396,
            quantity: 5,
            formation: "3x2",
